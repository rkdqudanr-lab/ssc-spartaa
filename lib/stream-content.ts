...
export const COMMON_SYSTEMS: StreamSystem[] = [
  { icon: 'Clock', title: '교시제 집중 자습', description: '7교시 · 12시간 순공 시스템으로|흔들리지 않는 집중력을 유지합니다.' },
  { icon: 'CheckSquare', title: '코멘터 출결 2중 관리', description: '카드와 태블릿 2중 출결 시스템으로|단 한 번의 이탈도 완벽하게 차단합니다.' },
  { icon: 'BarChart2', title: '다양한 학습 공간', description: '컨디션에 맞춰 선택할 수 있는|3가지 타입의 프리미엄 공간을 제공합니다.' },
  { icon: 'Heart', title: '정기 조회 및 멘탈 관리', description: '매달 성취감을 공유하고 슬럼프를 예방하는|정기 멘탈 케어 세션을 진행합니다.' },
  { icon: 'Home', title: '스터디 및 라운지 무상 지원', description: '개별 학습 외에도 개방형 카페와|휴게 공간을 자유롭게 이용 가능합니다.' }
]
...
export const streamContents: Record<StreamId, StreamContent> = {
  gongmuwon: {
    ...
    name: '공무원',
    hero: {
      title: '공무원 단기합격의|가장 확실한 길',
      subtitle: '국가직·지방직 맞춤형 관리와|인강에 최적화된 압도적 열공공간',
      description: '노량진 커넥츠프랩 공단기의|독한 관리 시스템을 그대로 이식했습니다.\n합격으로 증명하는 합격자의|교시제 출결 통제를 직접 경험하세요.',
    },
    differentiation: {
      title: '왜 공무원 시험은|SSC스파르타인가',
      items: [
        {
          title: '노량진 테스트|완벽하게 이식',
  ...
  suneung: {
    ...
    name: '수능(재수)',
    hero: {
      title: 'N수생의 합격 의지를|완성하는 결전의 장',
      subtitle: '독학재수의 불안함을 압도적 관리로|확신으로 바꾸는 유일한 공간',
      description: '단순한 자습실을 넘어선 초밀착 관리.\n수능 실전 바이오리듬에 맞춘 교시제로|당신의 1년을 가장 밀도 있게 채웁니다.',
    },
    differentiation: {
      title: '독학 재수, 실패 없는|성공 방정식을 제안합니다',
      items: [
        {
          title: '수능 맞춤형 교시제',
          desc: '수능 당일 시간표와 100% 동일한 교시제로|오직 학습에만 온전히 침잠할 수 있는|완벽한 실전 감각을 기릅니다.',
        },
        {
          title: '검증된 학습 콘텐츠',
          desc: '대성, 메가스터디 등 전국 모의고사 및|최상위권 수험 자료를 완비하여|노량진 본원과 동일한 혜택을 제공합니다.',
        },
        {
          title: '철저한 생활 관리',
          desc: '지각부터 무단결석, 스마트폰 소지까지|단호한 규정 적용으로 흐트러지기 쉬운|정신을 합격 직전까지 잡아줍니다.',
        }
      ]
    },
    faqs: [
      { q: '독학재수생을 위한|성적 관리 테스트가 있나요?', a: '가장 중요한 핵심 3과목인|국영수 테스트를 정기적으로 제공합니다.\n집중 학습을 통해 취약 과목을 보완하고|실전 감각을 유지합니다.' },
      { q: '사설 모의고사 및|외부 평가 시험 응시가 가능한가요?', a: '이감 모의고사 등|메이저 자료 이용이 가능하며,\n매월 \'더프(대성 더 프리미엄)\'를 실시하여|객관적으로 본인의 현재 위치를 파악합니다.' },
      { q: '학습 상담이나 멘토링은|어떻게 이루어지나요?', a: '정기적인 상담을 통해 취약점을 분석하고|주간 계획을 점검합니다.\n수험 생활 중 겪는 슬럼프 극복을 위한|심리 케어도 병행합니다.' },
    ],
    systems: [
      COMMON_SYSTEMS[0],
      COMMON_SYSTEMS[1],
  ...
  imyong: {
    ...
    name: '임용시험',
    hero: {
      title: '임용 합격의 마지막 관문|절대 몰입 공간',
      subtitle: '초/중/고 임용 수험생을 위한|친목 차단과 순공 시간 극대화',
  ...
  professional: {
    ...
    name: '전문자격사',
    hero: {
      title: '평범함을 거부하는|자격사 시험의 요새',
      subtitle: '세무사·노무사·CPA 준비생을 위한|성인 전용 프리미엄 관리반',
      description: '나태해지기 쉬운 성인 수험생을 위한|강력한 강제 교시제 시스템.\n합격이라는 결과만을 위해 설계된|철저한 전문가용 관리 시스템입니다.',
    },
    differentiation: {
      ...
      items: [
        {
          ...
          desc: '자격증 취득이라는 목표를 가진|성인 학습자들이 주축이 되어|상부 시너지를 내는 최상위 환경입니다.',
        },
        {
          title: '효율 극대화|교시제',
          desc: '짧은 시간의 몰입도를 최상으로 올리는|스파르타식 시간표로 과목별|암기 시간 단축을 돕습니다.',
        },
        {
          title: '피로를 잊는|베이스캠프',
          desc: '장시간 착석에 최적화된 메쉬 의자와|간접 조명으로 수험생의|만성 피로와 거북목을 방지합니다.',
        }
      ]
    },
    faqs: [
      { q: '계산기 사용이나|노트북 타이핑 작업은 어디서 하나요?', a: '세무사, 회계사 수험생을 위해|소음이 허용되는 \'라운지\' 공간을|별도로 운영합니다.\n열람실(무소음존) 밖에서 자유롭게 학습 가능합니다.' },
      { q: '학습 플래너 관리를|도와주시나요?', a: '네, 방대한 공부 분량을|체계적으로 소화하도록|코멘터가 주기적으로 플래너를 점검합니다.\n실행력을 높이는 것이 관리의 핵심입니다.' },
    ],
    systems: [
      COMMON_SYSTEMS[0],
      COMMON_SYSTEMS[1],
  ...
  job: {
    ...
    name: '취업준비',
    hero: {
      title: '공백기 깨고 합격,|효과적인 초단기 완성',
      subtitle: '가장 치열하게 준비하는|취업준비생을 위한 맞춤형 베이스캠프',
    ...
    differentiation: {
      ...
      items: [
        {
          title: '비실무 자격시험|특화',
          desc: '번거로운 준비보다는 단기 자격 취득과|NCS / 인적성 등 필기 위주의|빠른 스펙업에 몰입할 수 있습니다.',
        },
        {
          title: '자기소개서 집중|존',
          desc: '소음 방지 타이핑 존(라운지)이 마련되어 있어|눈치 보지 않고 자소서 수정 및|서류 접수에 완전한 집중이 가능합니다.',
        },
        {
          title: '취업 스터디|연계',
          desc: '인원 충족 시 오프라인 스터디룸을 통하여|NCS 리뷰나 면접 준비 스터디 결성을|적극적으로 돕고 있습니다.',
        }
      ]
    },
    faqs: [
      { q: '화상 면접이나 AI 면접을 볼 수 있는|프라이빗한 공간이 있나요?', a: '네, 독립된 프라이빗 스터디룸을 예약하여|타인의 방해 없이 화상 면접을 치를 수 있습니다.\n최상급 면접 환경을 보장합니다.' },
    ],
    systems: [
      COMMON_SYSTEMS[0],
      COMMON_SYSTEMS[1],
